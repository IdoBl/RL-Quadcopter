from tensorflow.contrib.keras import layers, models, optimizers, initializers
from tensorflow.contrib.keras import backend as K


############################################################################################
# Implementation of the critic method using the DDPG algorithm
...
class Critic:
    ...
    def build_model(self):
        ...
        # Add hidden layers - as described in https://pemami4911.github.io/blog/2016/08/21/ddpg-rl.html
        ...
        Q_values = layers.Dense(units=1,
                                kernel_initializer=initializers.RandomUniform(minval=-0.003, maxval=0.003, seed=None),
